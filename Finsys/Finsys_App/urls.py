...
urlpatterns = [
    ...
    # Recurring Bills
    path('fetch_rec_bills/<int:id>/',Fin_fetchRecBills),
    path('fetch_rec_bill_data/<int:id>/',Fin_fetchRecBillData),
    path('get_purchase_table_item_data/',Fin_getPurchaseTableItemData),
    path('check_rec_bill_no/',Fin_checkRecBillNo),
    path('create_new_rec_bill/',Fin_createRecBill),
    path('fetch_rec_bill_details/<int:id>/',Fin_fetchRecBillDetails),
    path('change_rec_bill_status/',Fin_changeRecBillStatus),
    path('add_rec_bill_comment/',Fin_addRecBillComment),
    path('add_rec_bill_attachment/',Fin_addRecBillAttachment),
    path('delete_rec_bill_comment/<int:id>/',Fin_deleteRecBillComment),
    path('fetch_rec_bill_history/<int:id>/',Fin_fetchRecBillHistory),
    path('delete_rec_bill/<int:id>/',Fin_deleteRecBill),
    path('rec_bill_pdf/',Fin_recBillPdf),
    path('share_rec_bill_email/',Fin_shareRecBillToEmail),
    path('check_vgstin/',Fin_checkVGstIn),
    path('check_vpan/',Fin_checkVPan),
    path('check_vphone/',Fin_checkVPhone),
    path('check_vemail/',Fin_checkVEmail),
    path('check_vend_name/',Fin_checkVndName),
    path('update_rec_bill/',Fin_updateRecBill),

    # Expense
    path('fetch_expenses/<int:id>/',Fin_fetchExpenses),
    path('fetch_expense_data/<int:id>/',Fin_fetchExpenseData),
    path('check_expense_no/',Fin_checkExpenseNo),
    path('create_new_expense/',Fin_createExpense),
    path('fetch_expense_details/<int:id>/',Fin_fetchExpenseDetails),
    path('change_expense_status/',Fin_changeExpenseStatus),
    path('add_expense_comment/',Fin_addExpenseComment),
    path('add_expense_attachment/',Fin_addExpenseAttachment),
    path('delete_expense_comment/<int:id>/',Fin_deleteExpenseComment),
    path('fetch_expense_history/<int:id>/',Fin_fetchExpenseHistory),
    path('delete_expense/<int:id>/',Fin_deleteExpense),
    path('expense_pdf/',Fin_expensePdf),
    path('share_expense_email/',Fin_shareExpenseToEmail),
    path('update_expense/',Fin_updateExpense),

    # Debit Note
    path('fetch_debit_notes/<int:id>/',Fin_fetchDebitNotes),
    path('fetch_debit_note_data/<int:id>/',Fin_fetchDebitNoteData),
    path('get_bill_numbers/',Fin_getBillNumbers),
    path('get_bill_numbers_edit/',Fin_getBillNumbersEdit),
    path('get_bill_items/',Fin_getBillItems),
    path('check_debit_note_no/',Fin_checkDebitNoteNo),
    path('create_new_debit_note/',Fin_createDebitNote),
    path('fetch_debit_note_details/<int:id>/',Fin_fetchDebitNoteDetails),
    path('change_debit_note_status/',Fin_changeDebitNoteStatus),
    path('add_debit_note_comment/',Fin_addDebitNoteComment),
    path('add_debit_note_attachment/',Fin_addDebitNoteAttachment),
    path('delete_debit_note_comment/<int:id>/',Fin_deleteDebitNoteComment),
    path('fetch_debit_note_history/<int:id>/',Fin_fetchDebitNoteHistory),
    path('delete_debit_note/<int:id>/',Fin_deleteDebitNote),
    path('debit_note_pdf/',Fin_debitNotePdf),
    path('share_debit_note_email/',Fin_shareDebitNoteToEmail),
    path('update_debit_note/',Fin_updateDebitNote),

    # Payment Made
    path('fetch_payments_made/<int:id>/',Fin_fetchPaymentsMade),
    path('get_payment_bills/',Fin_getPaymentBills),
    path('fetch_payment_made_data/<int:id>/',Fin_fetchPaymentMadeData),
    path('check_payment_made_no/',Fin_checkPaymentMadeNo),
    path('create_new_payment_made/',Fin_createPaymentMade),
    path('fetch_payment_made_details/<int:id>/',Fin_fetchPaymentMadeDetails),
    path('change_payment_made_status/',Fin_changePaymentMadeStatus),
    path('add_payment_made_comment/',Fin_addPaymentMadeComment),
    path('add_payment_made_attachment/',Fin_addPaymentMadeAttachment),
    path('delete_payment_made_comment/<int:id>/',Fin_deletePaymentMadeComment),
    path('fetch_payment_made_history/<int:id>/',Fin_fetchPaymentMadeHistory),
    path('delete_payment_made/<int:id>/',Fin_deletePaymentMade),
