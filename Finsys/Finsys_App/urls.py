...
urlpatterns = [
    ...
    # path('fetch_ret_invoice_details/<int:id>/',Fin_fetchRecInvoiceDetails),
    # path('change_ret_invoice_status/',Fin_changeRecInvoiceStatus),
    # path('add_ret_invoice_comment/',Fin_addRecInvoiceComment),
    # path('add_ret_invoice_attachment/',Fin_addRecInvoiceAttachment),
    # path('delete_ret_invoice_comment/<int:id>/',Fin_deleteRecInvoiceComment),
    # path('fetch_ret_invoice_history/<int:id>/',Fin_fetchRecInvoiceHistory),
    # path('delete_ret_invoice/<int:id>/',Fin_deleteRecInvoice),
    # path('ret_invoice_pdf/',Fin_recInvoicePdf),
    # path('share_ret_invoice_email/',Fin_shareRecInvoiceToEmail),
    # path('update_ret_invoice/',Fin_updateRecInvoice),
]
