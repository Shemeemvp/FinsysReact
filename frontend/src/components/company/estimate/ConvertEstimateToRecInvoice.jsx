...
function ConvertEstimateToRecInvoice() {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data.status) {
          ...
          setAdjustment(est.adjustment);
          setShippingCharge(est.shipping_charge);
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${config.base_url}/convert_estimate_to_rec_invoice/`, formData)
      .then((res) => {
        if (res.data.status) {
          Toast.fire({
            icon: "success",
        ...
        <div className="card radius-15 h-20">
          <div className="row">
            <div className="col-md-12">
              <center>
                <h2 className="mt-3">CONVERT ESTIMATE TO RECURRING INVOICE</h2>
              </center>
              <hr />
            </div>
          </div>
...
export default ConvertEstimateToRecInvoice;
