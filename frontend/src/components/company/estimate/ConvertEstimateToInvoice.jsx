...
function ConvertEstimateToInvoice() {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post(`${config.base_url}/convert_estimate_to_invoice/`, formData)
      .then((res) => {
        ...
        <div className="card radius-15 h-20">
          <div className="row">
            <div className="col-md-12">
              <center>
                <h2 className="mt-3">CONVERT ESTIMATE TO INVOICE</h2>
              </center>
              <hr />
            </div>
          </div>
...
export default ConvertEstimateToInvoice;
