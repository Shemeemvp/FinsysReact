...
function ViewEstimate() {
    ...
    axios
      ...
      .then((res) => {
        ...
        if (res.data.status) {
          ...
          if (est.file) {
            var url = `${config.base_url}/${est.file}`;
            setFileUrl(url);
          }
          ...
          setComments([]);
          itms.map((i) => {
            setestimateItems((prevState) => [...prevState, i]);
          });
          cmt.map((c) => {
            setComments((prevState) => [...prevState, c]);
          });
          setestimateDetails(est);
          if (hist) {
            setHistory(hist);
          }
        }
  ...
  function handleConvertEstimate() {
    Swal.fire({
      title: `Convert Estimate - ${estimateDetails.estimate_no}?`,
      ...
      if (result.isConfirmed) {
        ...
        axios
          .post(`${config.base_url}/change_estimate_status/`, st)
          .then((res) => {
            if (res.data.status) {
              Toast.fire({
                icon: "success",
  ...
  const saveEstimateComment = (e) => {
    ...
    axios
      .post(`${config.base_url}/add_estimate_comment/`, cmt)
      .then((res) => {
        console.log(res);
        if (res.data.status) {
          Toast.fire({
  ...
  function handleDeleteEstimate(id) {
    Swal.fire({
      title: `Delete Estimate - ${estimateDetails.estimate_no}?`,
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${config.base_url}/delete_estimate/${id}/`)
          .then((res) => {
            console.log(res);
  ...
  function deleteComment(id) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${config.base_url}/delete_estimate_comment/${id}/`)
          .then((res) => {
            console.log(res);
  ...
  function overview() {
    ...
    if (estimateDetails.status == "Draft") {
...
.equal-length-item {
  ...
  function slipPdf() {
    var EstimateNo = `${estimateDetails.estimate_no}`;
    var element = document.getElementById("slip");
    var opt = {
      margin: 1,
      filename: "Estimate_Slip_" + EstimateNo + ".pdf",
  ...
  function EstimatePdf() {
    ...
    axios
      .get(`${config.base_url}/estimate_pdf/`, {
        responseType: "blob",
        params: data,
      })
      .then((res) => {
        ...
        a.href = fileURL;
        a.download = `Estimate_${estimateDetails.estimate_no}.pdf`;
  ...
  function handleShareEmail(e) {
    ...
    if (emailsString === "") {
      ...
      if (invalidEmails.length > 0) {
        ...
        axios
          .post(`${config.base_url}/share_estimate_email/`, em)
          .then((res) => {
            if (res.data.status) {
              Toast.fire({
                icon: "success",
  ...
  function handleFileModalSubmit(e) {
    ...
    axios
      .post(`${config.base_url}/add_estimate_attachment/`, formData)
      .then((res) => {
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 d-flex justify-content-end">
                    ...
                    <a
                      ...
                      role="button"
                      onClick={() =>
                        handleDeleteEstimate(`${estimateDetails.id}`)
                      }
                      style={{ height: "fit-content", width: "fit-content" }}
                    >
                      &nbsp;Delete
                    ...
                    <div className="card-body">
                      ...
                      <div className="row mb-4 d-flex justify-content-between align-items-center">
                        ...
                        <div className="col-md-3 mt-3">
                          <h6 className="mb-0">Estimate No,</h6>
                        </div>
                        <div className="col-md-3 mt-3">
                          <p className="mb-0 text-right">
                            {estimateDetails.estimate_no}
                      ...
                      <div className="row mb-4 d-flex justify-content-between align-items-center">
                        <div className="col-md-3 mt-3">
                          <h6 className="mb-0">Estimate Date</h6>
                        </div>
                        <div className="col-md-3 mt-3">
                          <p className="mb-0 text-right">
                            {estimateDetails.estimate_date}
                          </p>
                        </div>
                      ...
                      <div className="row mb-4 d-flex justify-content-start align-items-center">
                        ...
                        <div className="col-md-3 mt-3 vr">
                          <p className="mb-0">{estimateDetails.billing_address}</p>
                        </div>
                        {/* <div className="col-md-3 mt-3 vl">
                        ...
                        <div className="col-md-3 mt-3">
                          <p className="mb-0 text-right">
                            {estimateDetails.payment_method}
                          </p>
                        </div> */}
                      </div>
                      ...
                      <div className="row mb-4 d-flex justify-content-between align-items-center">
                        ...
                        <div className="col-md-3 mt-3">
                          <p className="mb-0" style={{ textAlign: "right" }}>
                            {estimateDetails.gst_type}
                          </p>
                        </div>

                        {estimateDetails.gstin != "None" && (
                          <>
                            <div className="col-md-3 mt-3 vl">
                ...
                >
                  <div className="px-3 py-4">
                    ...
                    <div className="d-flex justify-content-between mb-4">
                      ...
                      {estimateDetails.tax_amount}
                    </div>
                    {estimateDetails.igst != 0 ? (
                      <div className="d-flex justify-content-between mb-4">
                        <h6 className="">IGST</h6>
                        {estimateDetails.igst}
                      </div>
                    ) : null}
                    {estimateDetails.cgst != 0 ? (
                      <div className="d-flex justify-content-between mb-4">
                        <h6 className="">CGST</h6>
                        {estimateDetails.cgst}
                      </div>
                    ) : null}
                    {estimateDetails.sgst != 0 ? (
                      <div className="d-flex justify-content-between mb-4">
                        <h6 className="">SGST</h6>
                        {estimateDetails.sgst}
                      </div>
                    ) : null}

                    {estimateDetails.shipping_charge != 0 ? (
                      <div className="d-flex justify-content-between mb-4">
                        <h6 className="">Shipping Charge</h6>
                        {estimateDetails.shipping_charge}
                      </div>
                    ) : null}

                    {estimateDetails.adjustment != 0 ? (
                      <div className="d-flex justify-content-between mb-4">
                        <h6 className="">Adjustment</h6>
                        {estimateDetails.adjustment}
                      </div>
                    ) : null}
                    <hr className="my-4" />
                    <div className="d-flex justify-content-between mb-4">
                ...
                <div id="whatToPrint1" className="printTemplates template1">
                  <div className="my-5 page pagesizea4" size="A4">
                    <div className="p-4" id="printdiv1">
                        ...
                        <div className="top-left">
                          ...
                          <div className="position-relative">
                            <p>
                              {" "}
                              Estimate No.{" "}
                              <span>{estimateDetails.estimate_no}</span>
                            </p>
                          </div>
                        </div>
                      </section>
                        ...
                        <div className="col-12">
                          ...
                          <div className="row extra-info pt-3">
                            <div className="col-6">
                              <p>
                                Estimate Date:{" "}
                                <span>{estimateDetails.estimate_date}</span>
                              </p>
                              {/* <p>
                                Payment Method:{" "}
                                <span>{estimateDetails.payment_method}</span>
                              </p> */}
                            </div>
                            <div className="col-6">
                              <p>
                                Expiration Date Date :{" "}
                                <span>{estimateDetails.exp_date}</span>
                              </p>
                            </div>
                          </div>
                        </div>
                      ...
                      <section className="product-area mt-1">
                        <table
                        ...
                        <div className="col-md-4 d-flex justify-content-end">
                          <div className="text-white">
                            <p className="mb-0 mt-2">
                              Estimate No:{" "}
                              <b>{estimateDetails.estimate_no}</b>
                            </p>
                          </div>
                        </div>
                      </div>
              ...
              <div className="slip-container bg-white" id="slip_container">
                <div className="slip text-dark">
                  ...
                  <div className="ml-4 mt-2" style={{ color: "black" }}>
                    <div className="row">
                      <div className="col-md-6 text-left">Estimate No:</div>
        ...
        <div className="modal-dialog modal-lg">
          <div className="modal-content" style={{ backgroundColor: "#213b52" }}>
            <div className="modal-header">
              <h5 className="m-3">Share Estimate Transactions</h5>
              <button
                type="button"
                className="close"
                data-dismiss="modal"
      ...
      >
        <div className="modal-dialog modal-lg" role="document">
          <div className="modal-content" style={{ backgroundColor: "#213b52" }}>
            ...
            <form onSubmit={saveEstimateComment} className="px-1">
