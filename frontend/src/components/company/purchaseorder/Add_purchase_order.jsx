...
function Add_Purchase_Order() {
  ...
  function checkSalesOrderNo(val) {
    ...
    if (so_num != "") {
      ...
      axios
        .get(`${config.base_url}/checkPurchaseOrderNo/`, { params: s })
        .then((res) => {
  ...
  const Create_new_purchase_order = (e) =>{
    e.preventDefault();
    var dt = {
      Id:ID,
      Vname:vendor,
    ...
    <>
      ...
      >
        ...
        <form
          ...
          onSubmit={Create_new_purchase_order}
        >
                ...
                <div className="card p-3">
                    <form method="post" id="newVendorForm" className="px-1">
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="col-md-3" style={{position:'relative',right:'10px'}}>
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="col-md-3" style={{position:'relative',right:'10px'}}>
                                ...
                                <input type="email" className="form-control" required id="vendEmail" name="email"  style={{backgroundColor:'#43596c',color:'white',width:'240px'}} placeholder="accuhub@gmail.com" value={Vmail} onChange={(e) => setVEmail(e.target.value)} onBlur={(e) => checkemail(e.target.value)}/>
                        ...
                        <div className="row mt-3">
                            ...
                            <div className="col-md-3 gstrow d-block" id="gstInValue">
                                <div>
                            ...
                            <div className="col-md-3">
                                ...
                                <select className="custom-select form-control" id="vendPlaceOfSupply" name="place_of_supply" style={{backgroundColor:'#43596c',color:'white',width:'220px'}} required value={VplaceOfSupply} onChange={(e) => setVPlaceOfSupply(e.target.value)}>
                        ...
                        <div className="row">
                            <div className="col-md-3 mt-3" >
                                ...
                                <select name="vendCurrency" id="vendCurrency" className="form-control" style={{backgroundColor:'#43596c',width:'240px'}} value={Vcurrency} onChange={(e) => setVCurrency(e.target.value)}>
                            ...
                            <div className="col-md-3 mt-3">
                                ...
                                <div className="d-flex">
                                    <select name="payment_terms" id="vendPaymentTerms" className="form-control" style={{backgroundColor:'#43596c',width:'180px'}} onChange={(e) => setVPaymentTerm(e.target.value)} value={VpaymentTerm}>
                                    ...
                                    <a href="#newPaymentTerm" data-dismiss="modal" data-toggle="modal" className="btn btn-outline-secondary ml-1" style={{width:'40px',height:'38px',position:'relative',bottom:'10px'}}>+</a>
                                </div>
                            </div>
    
                            <div className="col-md-3 mt-3" >
                                <label for="vendPriceList">Price List</label>
                                <select name="price_list" id="vendPriceList" className="form-control" style={{backgroundColor:'#43596c',width:'240px'}} value={VpriceList} onChange={(e) => setVPriceList(e.target.value)}>
                                    <option value="" selected>Choose</option>
                                    {priceLists.map((l) => (
                          <option value={l.id}>{l.name}</option>
                        ))}
