...
function PaymentMade() {
  ...
  const fetchPayments = () =>{
    axios.get(`${config.base_url}/fetch_payments_made/${ID}/`).then((res)=>{
      if(res.data.status){
        ...
        <div className="card radius-15 h-20">
          <div className="row">
            <div className="col-md-12">
              <center>
                <h2 className="mt-3">PAYMENTS MADE</h2>
              </center>
              <hr />
            </div>
          </div>
            ...
            <div className="container-fluid">
              <div className="row">
                ...
                <div className="col-md-6 d-flex justify-content-end">
                  ...
                  <Link to="/add_payment_made" className="ml-1">
                    <button
                      type="button"
                      style={{ width: "fit-content", height: "fit-content" }}
                      className="btn btn-outline-secondary text-grey"
                    >
                      <i className="fa fa-plus font-weight-light"></i> Payment Made
                    </button>
                  </Link>
                </div>
              </div>
              ...
              <tbody>
                {payment &&payment.map((i,index)=>(
                  <tr
                    ...
                    onClick={()=>navigate(`/view_payment_made/${i.id}/`)}
