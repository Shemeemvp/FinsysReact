...
function ViewDebitNote() {
    ...
    axios
      ...
      .then((res) => {
        if (res.data.status) {
          ...
          setComments([]);
          itms.map((i) => {
            setDebitNoteItems((prevState) => [...prevState, i]);
          });
          cmt.map((c) => {
            setComments((prevState) => [...prevState, c]);
          });
          setDebitNoteDetails(cNote);
          if (hist) {
            setHistory(hist);
          }
        }
  ...
  function convertDebitNote() {
    Swal.fire({
      title: `Convert Debit Note - ${debitNoteDetails.debit_note_no}?`,
      ...
      if (result.isConfirmed) {
        ...
        axios
          .post(`${config.base_url}/change_debit_note_status/`, st)
          .then((res) => {
            if (res.data.status) {
              Toast.fire({
                icon: "success",
  ...
  const DebitNoteComment = (e) => {
    ...
    axios
      .post(`${config.base_url}/add_debit_note_comment/`, cmt)
      .then((res) => {
        console.log(res);
        if (res.data.status) {
          Toast.fire({
  ...
  function deleteDebitNote(id) {
    Swal.fire({
      title: `Delete Debit Note - ${debitNoteDetails.debit_note_no}?`,
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${config.base_url}/delete_debit_note/${id}/`)
          .then((res) => {
            console.log(res);
  ...
  function deleteComment(id) {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`${config.base_url}/delete_debit_note_comment/${id}/`)
          .then((res) => {
            console.log(res);
  ...
  function overview() {
    ...
    if (debitNoteDetails.status == "Draft") {
...
.equal-length-item {
  ...
  function slipPdf() {
    var cnNo = `${debitNoteDetails.debit_note_no}`;
    var element = document.getElementById("slip");
    var opt = {
      margin: 1,
      filename: "DebitNoteSlip_" + cnNo + ".pdf",
  ...
  function debitNotePdf() {
    var data = {
      Id: ID,
      dn_id: debitNoteId,
    };
    axios
      .get(`${config.base_url}/debit_note_pdf/`, {
        responseType: "blob",
        params: data,
      })
      .then((res) => {
        ...
        a.href = fileURL;
        a.download = `DebitNote_${debitNoteDetails.debit_note_no}.pdf`;
  ...
  function handleShareEmail(e) {
    ...
    if (emailsString === "") {
      ...
      if (invalidEmails.length > 0) {
        ...
        axios
          .post(`${config.base_url}/share_debit_note_email/`, em)
          .then((res) => {
            if (res.data.status) {
              Toast.fire({
                icon: "success",
  ...
  function handleFileModalSubmit(e) {
    ...
    axios
      .post(`${config.base_url}/add_debit_note_attachment/`, formData)
      .then((res) => {
        if (res.data.status) {
          Toast.fire({
            icon: "success",
              ...
              <div className="container-fluid">
                <div className="row">
                  ...
                  <div className="col-md-6 d-flex justify-content-end">
                    ...
                    <Link
                      to={`/edit_debit_note/${debitNoteId}/`}
                    ...
                    <a
                      ...
                      id="deleteBtn"
                      role="button"
                      onClick={() => deleteDebitNote(debitNoteId)}
                      style={{ height: "fit-content", width: "fit-content" }}
                    >
                      &nbsp;Delete
                    </a>
                    ...
                    <Link
                      to={`/debit_note_history/${debitNoteId}/`}
                    ...
                    <div className="card-body">
                      <div className="card-title">
                        <div className="row">
                          <div className="col mt-3">
                            <h2 className="mb-0">
                              # {debitNoteDetails.debit_note_no}
                            </h2>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className="row mb-4 d-flex justify-content-between align-items-center">
                        ...
                        <div className="col-md-3 mt-3">
                          <h6 className="mb-0">Debit Note No,</h6>
                        </div>
                        <div className="col-md-3 mt-3">
                          <p className="mb-0 text-right">
                            {debitNoteDetails.debit_note_no}
                      ...
                      <div className="col-md-3 mt-3">
                        <p className="mb-0 text-right">
                          {debitNoteDetails.reference_no}
                        </p>
                      </div>
                        <div className="col-md-3 mt-3 vl">
                          <h6 className="mb-0">Debit Note Date</h6>
                        </div>
                        <div className="col-md-3 mt-3">
                          <p className="mb-0 text-right">
                      ...
                      <div className="row mb-4 d-flex justify-content-start align-items-center">
                        ...
                        <div className="col-md-3 mt-3 vr">
                          <p className="mb-0">{debitNoteDetails.bill_type}</p>
                        </div>
                        {debitNoteDetails.bill_number ? (
                          <>
                            <div className="col-md-3 mt-3 vl">
                              <h6 className="mb-0">Bill Number</h6>
                            </div>
                            <div className="col-md-3 mt-3">
                              <p className="mb-0 text-right">
                                {debitNoteDetails.bill_number}
                      ...
                      <div className="row mb-4 d-flex justify-content-start align-items-center">
                        ...
                        <div className="col-md-3 mt-3">
                          <p className="mb-0">
                            {debitNoteDetails.billing_address}
                          </p>
                        </div>
                        {debitNoteDetails.payment_method != "" && debitNoteDetails.payment_method != "null" &&(
                          <>
                          <div className="col-md-3 mt-3 vl">
                          ...
                          <div className="col-md-3 mt-3">
                            <p className="mb-0 text-right">
                              {debitNoteDetails.payment_method}
                            </p>
                          </div>
                          </>
                        )}
                      ...
                      <div className="row mb-4 d-flex justify-content-between align-items-center">
                        ...
                        <div className="col-md-3 mt-3">
                          <p className="mb-0" style={{ textAlign: "right" }}>
                            {debitNoteDetails.gst_type}
                          </p>
                        </div>

                        {debitNoteDetails.gstin != "None" && (
                          <>
                            <div className="col-md-3 mt-3 vl">
                ...
                >
                  <div className="px-3 py-4">
                    ...
                    <div className="d-flex justify-content-between mb-4">
                      ...
                      {debitNoteDetails.subtotal}
                    </div>
                    <div className="d-flex justify-content-between mb-4">
                      <h6 className="">Tax Amount</h6>
                      {debitNoteDetails.tax_amount}
                    </div>
                    {debitNoteDetails.igst != 0 ? (
                      <div className="d-flex justify-content-between mb-4">
                        <h6 className="">IGST</h6>
                        {debitNoteDetails.igst}
                      </div>
                    ) : null}
                    {debitNoteDetails.cgst != 0 ? (
                      <div className="d-flex justify-content-between mb-4">
                        <h6 className="">CGST</h6>
                        {debitNoteDetails.cgst}
                      </div>
                    ) : null}
                    {debitNoteDetails.sgst != 0 ? (
                      <div className="d-flex justify-content-between mb-4">
                        <h6 className="">SGST</h6>
                        {debitNoteDetails.sgst}
                      </div>
                    ) : null}

                    {debitNoteDetails.shipping_charge != 0 ? (
                      <div className="d-flex justify-content-between mb-4">
                        <h6 className="">Shipping Charge</h6>
                        {debitNoteDetails.shipping_charge}
                      </div>
                    ) : null}

                    {debitNoteDetails.adjustment != 0 ? (
                      <div className="d-flex justify-content-between mb-4">
                        <h6 className="">Adjustment</h6>
                        {debitNoteDetails.adjustment}
                      </div>
                    ) : null}
                    <div className="d-flex justify-content-between mb-4">
                      <h6 className="">Grand Total</h6>
                      <span className="font-weight-bold">
                        {debitNoteDetails.grandtotal}
                      </span>
                    </div>
                    <hr className="my-4" />
                    <div className="d-flex justify-content-between mb-4">
                      ...
                      <span className="font-weight-bold">
                        {debitNoteDetails.paid != "" ? debitNoteDetails.paid : 0.0}
                      </span>
                    </div>
                    <div className="d-flex justify-content-between mb-4">
                      <h6 className="">Balance</h6>
                      <span className="font-weight-bold">
                        {debitNoteDetails.balance}
                      </span>
                    </div>
                  </div>
                </div>
                      ...
                      <section className="top-content bb d-flex justify-content-between p-0">
                        ...
                        <div className="top-left">
                          ...
                          <div className="position-relative">
                            <p>
                              Debit Note No.
                              <span>{debitNoteDetails.debit_note_no}</span>
                            </p>
                          </div>
                        </div>
                      </section>
                        ...
                        <div className="col-md-4 d-flex justify-content-end">
                          <div className="text-white">
                            <p className="mb-0 mt-2">
                              Debit Note No:{" "}
                              <b>{debitNoteDetails.debit_note_no}</b>
                            </p>
                          </div>
                        </div>
                      </div>
              ...
              <div className="slip-container bg-white" id="slip_container">
                <div className="slip text-dark">
                  ...
                  <div className="ml-4 mt-2" style={{ color: "black" }}>
                    <div className="row">
                      <div className="col-md-6 text-left">Debit Note No:</div>
                  ...
                  <div className="paid-by mb-4 d-flex justify-content-between">
                    <span>Paid By:</span>
                    <span>{debitNoteDetails.payment_method}</span>
                  </div>
        ...
        <div className="modal-dialog modal-lg">
          <div className="modal-content" style={{ backgroundColor: "#213b52" }}>
            <div className="modal-header">
              <h5 className="m-3">Share Debit Note</h5>
              <button
                type="button"
                className="close"
                data-dismiss="modal"
                ...
                <div className="card p-3 w-100">
                  ...
                  <div className="form-group mt-2">
                    ...
                    <textarea
                      ...
                      placeholder="This message will be sent along with Debit Note details."
                    />
                  </div>
                </div>
                <div
      ...
      >
        <div className="modal-dialog modal-lg" role="document">
          <div className="modal-content" style={{ backgroundColor: "#213b52" }}>
            ...
            <form onSubmit={DebitNoteComment} className="px-1">
